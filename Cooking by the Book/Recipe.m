...
-(id)init{
    return [self initBasicWithTitle:nil withID:nil withDesc:nil withImageName:nil withTagAry:nil withRating:nil];
}
...
-(id)initBasicWithTitle:(NSString *)title_ withID:(NSString *)recipeID_ withDesc:(NSString *)desc_ withImageName:(NSString *)imageName_ withTagAry:(NSArray *)tagAry_ withRating:(NSNumber *)rating_{
    return [self initDetailedWithTitle:title_ withID:recipeID_ withDesc:desc_ withImageName:imageName_ withTagAry:tagAry_ withPrepTime:nil withCookTime:nil withTotTime:nil withPortionNum:nil withIngredientAry:nil withStepAry:nil withImage:nil withRating:rating_];
}
